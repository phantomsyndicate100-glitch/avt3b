...
function AdminModal({
  ...
  const [isLoggedIn, setIsLoggedIn] = reactExports.useState(authenticated);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[9999] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "dialog",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-[#00ff88] animate-glow-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-[#00ff88] tracking-widest uppercase", children: "System Access" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl tracking-wide text-white uppercase", children: isLoggedIn ? "ADMIN PANEL" : "AUTHENTICATE" })
          ] }),
        ...
        !isLoggedIn ? (
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-white/20 text-center tracking-wider", children: "Hint: Press A key 3 times to trigger" })
          ] })
        ) : (
          /* Admin panel — navigate to sections */
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-[#00ff88] tracking-wider uppercase mb-4", children: "✓ Authenticated — Navigate to section:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: SECTIONS.map((section, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-full bg-[rgba(0,255,136,0.1)] my-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase", children: "05 / ABOUT AVT3B" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-[clamp(2rem,5vw,4.5rem)] leading-none tracking-wide text-white uppercase mt-2", children: [
              "ONE ECOSYSTEM.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-glow", children: " INFINITE SCALE." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-16 bg-[#00ff88] mt-4" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-up fade-up-delay-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 leading-relaxed mb-6 font-body text-base", children: "AVT3B is a system-driven company built to create, automate, and scale multiple digital income streams through structured processes, AI tools, and data-driven execution." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 leading-relaxed mb-8 font-body text-base", children: "It focuses on building strong foundations, developing scalable products, and achieving long-term growth by integrating trading, automation, and digital systems into one centralized, efficient ecosystem." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-[rgba(0,255,136,0.25)] rounded-lg p-5 bg-[rgba(0,255,136,0.03)]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 bg-[#00ff88] rounded-full animate-glow-pulse" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase", children: "Mission Statement" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl text-white tracking-wide uppercase", children: "Scale Beyond Individuals." })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: PILLARS.map((pillar, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl mb-2", children: pillar.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base tracking-wide text-white uppercase mb-1 group-hover:text-accent-glow transition-colors duration-300", children: pillar.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-white/40 leading-relaxed", children: pillar.desc })
                ]
              },
              pillar.title
            )) })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-2xl mx-auto w-full text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase", children: "08 / CONTACT" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-[clamp(2.5rem,6vw,5rem)] leading-none tracking-wide text-white uppercase mt-2", children: [
              "LET'S ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-glow", children: "CONNECT" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-16 bg-[#00ff88] mt-4 mx-auto" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-white/40 font-body text-sm leading-relaxed max-w-md mx-auto", children: "Ready to build something that actually works? Let's talk strategy, systems, and execution." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4 mb-8", children: CONTACTS.map((contact, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: contact.href,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 flex items-center justify-center rounded-full border border-[rgba(0,255,136,0.3)] text-[#00ff88] group-hover:border-[#00ff88] group-hover:shadow-glow-sm transition-all duration-300 shrink-0", children: contact.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] text-white/30 tracking-wider uppercase mb-0.5", children: contact.platform }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-white/80 group-hover:text-[#00ff88] transition-colors duration-300 truncate", children: contact.handle })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto text-[#00ff88] opacity-0 group-hover:opacity-100 transition-opacity duration-300 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
                    width: "14",
                    height: "14",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "WORK WITH ME" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
                    width: "16",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 fade-up fade-up-delay-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-[10px] text-white/20 tracking-widest", children: [
            "© ",
            (/* @__PURE__ */ new Date()).getFullYear(),
            " AVT3B — Prince Sharma. Built with love using",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
...
function HeroSection({ goNext }) {
  const wordRef = reactExports.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-8 left-8 w-8 h-8 border-t-2 border-l-2 border-[rgba(0,255,136,0.4)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-8 right-8 w-8 h-8 border-t-2 border-r-2 border-[rgba(0,255,136,0.4)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-20 left-8 w-8 h-8 border-b-2 border-l-2 border-[rgba(0,255,136,0.4)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-20 right-8 w-8 h-8 border-b-2 border-r-2 border-[rgba(0,255,136,0.4)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-8 left-1/2 -translate-x-1/2 flex items-center gap-2 fade-up", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[#00ff88] animate-glow-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase", children: "FOUNDER — AVT3B" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[#00ff88] animate-glow-pulse" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-6 max-w-6xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 mb-6 fade-up fade-up-delay-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-sm md:text-base tracking-[0.4em] text-white/50 uppercase", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: TAGLINE_WORDS[0]
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-24 mx-auto bg-gradient-to-r from-transparent via-[#00ff88] to-transparent mb-8 fade-up fade-up-delay-2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 fade-up fade-up-delay-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: "EXPLORE MY UNIVERSE" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 bg-[#00cc6a] scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-300" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-20 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40 fade-up fade-up-delay-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] tracking-widest text-white uppercase", children: "Scroll Down" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-gradient-to-b from-white/40 to-transparent animate-float" })
        ] })
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase", children: "07 / MESSAGE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-[clamp(2.5rem,6vw,5rem)] leading-none tracking-wide text-white uppercase mt-2", children: [
              "THE ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-glow", children: "MINDSET" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-16 bg-[#00ff88] mt-4 mx-auto" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5", children: MESSAGES.map((msg, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": `message.item.${i + 1}`,
              className: `glass-card rounded-lg p-7 group hover:border-[rgba(0,255,136,0.5)] transition-all duration-300 hover:shadow-glow-md fade-up ${i === 0 ? "sm:col-span-2 text-center" : ""}`,
              style: { animationDelay: `${i * 0.12}s` },
              children: [
                i === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl text-[rgba(0,255,136,0.3)] font-mono mb-3 leading-none", children: '"' }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: `font-display tracking-wide text-white uppercase group-hover:text-accent-glow transition-colors duration-300 ${i === 0 ? "text-3xl md:text-5xl mb-3" : "text-2xl mb-2"}`,
                    children: msg.quote
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-white/40 leading-relaxed", children: msg.sub }),
                i === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-24 bg-gradient-to-r from-transparent via-[#00ff88] to-transparent mt-5 mx-auto" })
              ]
            },
            msg.quote
          )) })
...
async function getActor() {
  ...
  try {
    const mod2 = await __vitePreload(() => import("./backend-Ciie85-6.js"), true ? [] : void 0);
    actorInstance = mod2;
  } catch {
    actorInstance = null;
  }
...
async function callBackend(methodName, args = []) {
  try {
    ...
    const backend = actor.default ?? actor;
...
function useProducts() {
  ...
  const fetchProducts = reactExports.useCallback(async () => {
    ...
    setError(null);
    try {
      const result = await callBackend("getProducts");
      if (result !== null) {
        setProducts(result);
      }
    } catch (err) {
  ...
  const addProduct = reactExports.useCallback(
    async (data) => {
      try {
        const result = await callBackend("addProduct", [
          data.name,
          data.price,
          data.image_url,
          data.razorpay_link,
  ...
  const updateProduct = reactExports.useCallback(
    async (id, data) => {
      try {
        const result = await callBackend("updateProduct", [
          id,
          data.name,
          data.price,
          data.image_url,
  ...
  const deleteProduct = reactExports.useCallback(async (id) => {
    try {
      const result = await callBackend("deleteProduct", [id]);
      if (result) {
  ...
  const getUploadUrl = reactExports.useCallback(
    async (filename, contentType) => {
      return callBackend("getUploadUrl", [filename, contentType]);
    },
    []
  );
  reactExports.useEffect(() => {
...
function ProductCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-40 bg-[rgba(0,255,136,0.03)] overflow-hidden", children: [
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-4xl text-[rgba(0,255,136,0.2)] uppercase", children: "AVT3B" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 right-3 bg-[#00ff88] text-black font-mono text-xs px-2 py-1 rounded font-bold", children: [
            "₹",
            product.price.toLocaleString("en-IN")
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base tracking-wide text-white uppercase mb-2 group-hover:text-accent-glow transition-colors duration-300", children: product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-auto pt-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: product.razorpay_link,
                "data-ocid": `products.buy_button.${index2}`,
                target: "_blank",
                rel: "noopener noreferrer",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto w-full flex flex-col h-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between mb-6 fade-up shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase", children: "09 / PRODUCTS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-[clamp(2rem,4vw,4rem)] leading-none tracking-wide text-white uppercase mt-1", children: [
                "DIGITAL ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-glow", children: "PRODUCTS" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-16 bg-[#00ff88] mt-3" })
            ] }),
            adminAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto pr-1", children: [
            loading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 rounded-full border-2 border-[#00ff88] border-t-transparent animate-spin" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-white/40 tracking-wider", children: "LOADING PRODUCTS..." })
                ]
              }
            ),
            error && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-red-400", children: error })
              }
            ),
            !loading && !error && products.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": "products.empty_state",
                className: "flex flex-col items-center justify-center h-40 gap-3",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-4xl text-white/10 uppercase", children: "No Products Yet" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-white/30", children: adminAuthenticated ? 'Press the "+ ADD PRODUCT" button to add your first product.' : "Products coming soon." })
                ]
              }
            ),
            !loading && !error && products.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4", children: products.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              ProductCard,
              {
                product,
                index: i + 1,
        ...
        showForm && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-lg w-full max-w-md p-6 border border-[rgba(0,255,136,0.3)]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl tracking-wide text-white uppercase", children: editProduct ? "Edit Product" : "Add Product" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        children: uploading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded-full border border-[#00ff88] border-t-transparent animate-spin" }),
                          "UPLOADING…"
                        ] }) : "↑ UPLOAD IMAGE"
                      }
                    ),
                  ...
                  uploadError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-red-400 mb-1", children: uploadError }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                  ...
                  form.image_url && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: form.image_url,
                      alt: "Preview",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "label",
                    {
                      ...
                      children: [
                        "Description",
                        " ",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/20 normal-case tracking-normal", children: "(optional)" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: saving ? "SAVING..." : editProduct ? "UPDATE" : "ADD"
                    }
                  )
                ] })
              ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase", children: "04 / SKILLS" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-[clamp(2.5rem,6vw,5rem)] leading-none tracking-wide text-white uppercase mt-2", children: [
              "CORE ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-glow", children: "COMPETENCIES" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-16 bg-[#00ff88] mt-4" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4", children: SKILLS.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg tracking-wide text-white uppercase group-hover:text-accent-glow transition-colors duration-300", children: skill.category }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-xs text-[#00ff88] ml-4 shrink-0", children: [
                      skill.level,
                      "%"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-full bg-white/10 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: skill.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase", children: "02 / WHAT I BUILD" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-[clamp(2.5rem,6vw,5rem)] leading-none tracking-wide text-white uppercase mt-2", children: [
              "BUILDING THE",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-glow", children: " FUTURE" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-16 bg-[#00ff88] mt-4" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: BUILD_ITEMS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl tracking-wide text-white uppercase mb-2 group-hover:text-accent-glow transition-colors duration-300", children: item.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/50 leading-relaxed mb-4 font-body", children: item.desc }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: item.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase fade-up", children: "03 / WHO I AM" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-none tracking-wide text-white uppercase mt-2 mb-6 fade-up fade-up-delay-1", children: [
              "TRADER. BUILDER.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-glow", children: " STRATEGIST." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 leading-relaxed mb-8 max-w-lg fade-up fade-up-delay-2 font-body", children: "I combine technical expertise with strategic thinking to build systems that generate real results. Not theory — execution. Every system I build is tested in live markets and real businesses." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-8 fade-up fade-up-delay-3", children: ROLES.map((role, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "border-l-2 border-[#00ff88] pl-4 fade-up fade-up-delay-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl tracking-wide text-white uppercase", children: '"Systems beat motivation."' }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("cite", { className: "font-mono text-xs text-white/40 mt-1 block not-italic", children: "— Prince Sharma" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            STATS.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { animationDelay: `${0.2 + i * 0.1}s` },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-4xl text-accent-glow mb-2 group-hover:animate-text-glow", children: stat.value }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xs text-white/40 tracking-wider uppercase", children: stat.label })
                ]
              },
              stat.label
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 glass-card rounded-lg p-5 border border-[rgba(0,255,136,0.2)] fade-up fade-up-delay-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-[#00ff88] animate-glow-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-wider uppercase", children: "Founder @ AVT3B" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 text-sm font-body", children: "Building a system-driven company that creates, automates, and scales multiple digital income streams." })
            ] })
          ] })
        ] })
      ]
...
function WorkSystemSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      className: "relative w-full h-screen flex flex-col justify-center overflow-hidden bg-[#000000] px-6 py-12",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none opacity-[0.03]", children: SCAN_LINES.map((letter, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest uppercase", children: "06 / WORK SYSTEM" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-[clamp(2.5rem,6vw,5rem)] leading-none tracking-wide text-white uppercase mt-2", children: [
              "THE ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-glow", children: "PROCESS" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-16 bg-[#00ff88] mt-4" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: STEPS.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: { animationDelay: `${i * 0.12}s` },
              children: [
                i < STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:block absolute top-8 left-full w-full h-px border-t border-dashed border-[rgba(0,255,136,0.2)] z-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-lg p-6 relative z-10 h-full group-hover:border-[rgba(0,255,136,0.4)] transition-all duration-300 group-hover:shadow-glow-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-4xl text-[rgba(0,255,136,0.15)] font-bold mb-3 group-hover:text-[rgba(0,255,136,0.3)] transition-colors duration-300", children: step.number }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl mb-3", children: step.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl tracking-wide text-white uppercase mb-2 group-hover:text-accent-glow transition-colors duration-300", children: step.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-white/40 leading-relaxed", children: step.desc })
                ] })
              ]
            },
            step.title
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 flex items-center justify-center fade-up fade-up-delay-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4", children: STEPS.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[#00ff88] tracking-widest", children: step.title }),
...
function App() {
  ...
  const [adminAuthenticated, setAdminAuthenticated] = reactExports.useState(false);
  const [cursorPos, setCursorPos] = reactExports.useState({ x: -100, y: -100 });
  const [cursorHovered, setCursorHovered] = reactExports.useState(false);
  const aKeyPressesRef = reactExports.useRef([]);
  ...
  const goTo = reactExports.useCallback(
    (index2) => {
      if (isTransitioning || index2 === currentSection) return;
      if (index2 < 0 || index2 >= TOTAL_SECTIONS) return;
  ...
  reactExports.useEffect(() => {
    const handleKey = (e) => {
      ...
      if (e.key === "a" || e.key === "A") {
        const now2 = Date.now();
        aKeyPressesRef.current = [...aKeyPressesRef.current, now2].filter(
          (t) => now2 - t < 1e3
        );
  ...
  reactExports.useEffect(() => {
    ...
    el == null ? void 0 : el.addEventListener("touchstart", handleTouchStart, { passive: true });
    el == null ? void 0 : el.addEventListener("touchend", handleTouchEnd, { passive: true });
    return () => {
      el == null ? void 0 : el.removeEventListener("touchstart", handleTouchStart);
      el == null ? void 0 : el.removeEventListener("touchend", handleTouchEnd);
    };
  }, [goNext, goPrev]);
  reactExports.useEffect(() => {
  ...
  const handleAdminLogin = reactExports.useCallback((password) => {
  ...
  const handleAdminClose = reactExports.useCallback(() => {
    setShowAdminModal(false);
  }, []);
  const handleSectionNavigate = reactExports.useCallback(
    (section) => {
      ...
      children: [
          ...
          "nav",
          {
            ...
            children: SECTIONS.map((section, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `relative group w-2 h-2 rounded-full transition-all duration-300 ${i === currentSection ? "bg-[#00ff88] shadow-glow-md scale-125" : "bg-white/20 hover:bg-white/50"}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-5 top-1/2 -translate-y-1/2 text-xs font-mono text-[#00ff88] whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-black/80 px-2 py-0.5 rounded border border-[rgba(0,255,136,0.2)] pointer-events-none", children: section.label })
              },
              section.id
            ))
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-8 left-1/2 -translate-x-1/2 z-50 flex items-center gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-xs text-white/40 tabular-nums", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, { goNext }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WhatIBuildSection, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WhoIAmSection, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkillsSection, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AboutSection, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WorkSystemSection, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSection, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContactSection, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductsSection, { adminAuthenticated }) })
            ]
          }
        ),
        showAdminModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
          AdminModal,
          {
...
export {
  ...
  bitGet as X,
  sha256 as Y,
  numberToBytesBE as Z,
  _validateObject as _,
  safeReadUint8 as a,
  UnknownError as a0,
  HashTreeDecodeErrorCode as a1,
  uint8Equals as a2,
  ProtocolError as a3,
  CertificateVerificationErrorCode as a4,
  TrustError as a5,
  CertificateTimeErrorCode as a6,
  UnexpectedErrorCode as a7,
  CertificateHasTooManyDelegationsErrorCode as a8,
  CertificateNotAuthorizedErrorCode as a9,
  HttpErrorCode as aA,
  TransportError as aB,
  HttpFetchErrorCode as aC,
  MalformedSignatureErrorCode as aD,
  CertificateOutdatedErrorCode as aE,
  MissingSignatureErrorCode as aF,
  HttpDefaultFetchErrorCode as aG,
  RequestStatusDoneNoReplyErrorCode as aH,
  RejectError as aI,
  CertifiedRejectErrorCode as aJ,
  InvalidReadStateRequestErrorCode as aK,
  MissingCanisterIdErrorCode as aL,
  UncertifiedRejectErrorCode as aM,
  UncertifiedRejectUpdateErrorCode as aN,
  ...
  ED25519_OID as ak,
  unwrapDER as al,
  DerDecodeErrorCode as am,
  hashOfMap as an,
  IC_RESPONSE_DOMAIN_SEPARATOR as ao,
  MalformedPublicKeyErrorCode as ap,
  ed25519 as aq,
  QuerySignatureVerificationFailedErrorCode as ar,
  AnonymousIdentity as as,
  IngressExpiryInvalidErrorCode as at,
  CreateHttpAgentErrorCode as au,
  IdentityInvalidErrorCode as av,
  requestIdOf as aw,
  HttpV3ApiNotSupportedErrorCode as ax,
  TimeoutWaitingForResponseErrorCode as ay,
  uint8FromBufLike as az,
  writeUIntLE as b,
  readUIntLE as c,
  safeRead as d,
  concat as e,
  ...
  mod as o,
  concatBytes as p,
  bytesToNumberBE as q,
  readIntLE as r,
  slebEncode as s,
  isBytes as t,
  uint8ToDataView as u,
  Field as v,
  writeIntLE as w,
  _createCurveFields as x,
  wNAF as y,
  ensureBytes as z
};
