...
Service({
  ...
  "addProduct": Func(
    [Text, Float64, Text, Text, Text, Opt(Text)],
    [Product],
    []
  ),
  "deleteProduct": Func([Nat], [Bool], []),
  "getProducts": Func([], [Vec(Product)], ["query"]),
  "getUploadUrl": Func([Text, Text], [Text], []),
  "updateProduct": Func(
    [
      Nat,
      Text,
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    ...
    "getUploadUrl": IDL2.Func([IDL2.Text, IDL2.Text], [IDL2.Text], []),
...
class Backend {
  ...
  async addProduct(arg0, arg1, arg2, arg3, arg4, arg5) {
    if (this.processError) {
      try {
  ...
  async updateProduct(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    if (this.processError) {
      try {
